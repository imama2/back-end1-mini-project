...
// Source: back-end1-mini-project/repositories (interfaces: CustomerRepositoryInterface)
...
func (m *MockCustomerRepositoryInterface) DeleteCustomerById(arg0 uint) error {
	m.ctrl.T.Helper()
...
func (mr *MockCustomerRepositoryInterfaceMockRecorder) DeleteCustomerById(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteCustomerById", reflect.TypeOf((*MockCustomerRepositoryInterface)(nil).DeleteCustomerById), arg0)
}
